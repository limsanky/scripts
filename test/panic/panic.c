...
void loop(void)
{
  ...
  *(uint32_t*)0x20000054 = -1;
  memcpy((void*)0x20000058, "\x01\x00\x00\x00\x01\x00\x00\x00\x1c\x00\x12\x00"
                            "\x0c\x00\x01\x00\x62\x72\x69\x64\x67\x65",
         22);
  ...
  *(uint32_t*)0x20000288 = 0x2000000;
  *(uint32_t*)0x20000348 = 0xc;
  *(uint64_t*)0x20000350 = 0;
  *(uint64_t*)0x20000358 = 1;
  *(uint64_t*)0x20000360 = 0;
  *(uint64_t*)0x20000368 = 0;
  *(uint32_t*)0x20000370 = 0x40044;
  syscall(__NR_sendmsg, -1, 0x20000340ul, 0x4044854ul);
  *(uint64_t*)0x200007c0 = 0;
  *(uint32_t*)0x200007c8 = 0;
  *(uint64_t*)0x200007d0 = 0x20000080;
  *(uint64_t*)0x20000080 = 0x20000240;
  memcpy((void*)0x20000240, "\x4c\x00\x00\x00\x24\x00\x0b\x0e\x00\x00\x00\x00"
                            "\x00\x00\x00\x00\x00\x00\x00\x00",
         20);
  *(uint32_t*)0x20000254 = -1;
  memcpy((void*)0x20000258, "\x00\x00\x00\x00\xff\xff\xff\xff\x00\x00\x00\x00"
                            "\x0a\x00\x01\x00\x6e\x65\x74\x65\x6d\x00\x00\x00"
                            "\x1c\x00\x02\x00\x00\x00\x00\x00\xfe\xff\x01\x00"
                            "\x00\x00\xbc\xd5",
         40);
